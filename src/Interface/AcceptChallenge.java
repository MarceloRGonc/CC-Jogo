 ...
 * @author Grupo 04
 */
public class AcceptChallenge extends javax.swing.JFrame {

    private String desafio;
    private String username;
    private Communication s;
    
    public AcceptChallenge(Communication s, String user) {
        this.s = s;
        this.username = user;
        initComponents();
    ...
    private void acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptActionPerformed
        ...
        if(!this.desafio.equals("")){                
            ...
            try {
                ...
                PDU a = new PDU(9,list.size(),r.length,list);
                this.s.sendPDU(a); 
            ...
            if(campos != null) {
                if(campos.get(campos.indexOf(new Fields(0,""))).getInfo().equals("OK")) {
                    ...
                    new OkDialog(this).show("O desafio " + n + " foi aceite! Aguarde pelo início.");
                    ...
                    new OkDialog(this).show("Não consegui aceitar o desafio!");
